...
off_range = linspace(-600, 600, 1201)';
...
text(-0.2, 90, ['ENG -',num2str((1-sar2/sar1)*100,'%.0f'),'%'], 'FontSize', 26, 'Color', 'r');
...
ylim([-50 450]); xticks([0 2 4 6 8]);  xlim([-0.5 8.5]);
legend('HS', 'DeepRF'); set(gca,'FontName','Arial','FontSize',20,'LineWidth',1.5);
...
xticks(-600:300:600); ylim([0.5 2.0]);
...
%% log plot
figure; imagesc(off_range, b1_range, log10(abs(1+m1)), [-6 0]);
set(gca,'FontName','Arial','FontSize',20,'LineWidth',1.5);
ylabel('B_1', 'FontSize', 22); 
xlabel('Frequency (Hz)', 'FontSize', 22);
title('\fontsize{22}Log plot of |1+M\fontsize{18}z\fontsize{22}| (HS)');
xticks(-200:100:200); yticks(0.5:0.5:2.0);

figure; imagesc(off_range, b1_range, log10(abs(1+m2)), [-6 0]);
set(gca,'FontName','Arial','FontSize',20,'LineWidth',1.5);
ylabel('B_1', 'FontSize', 22); 
xlabel('Frequency (Hz)', 'FontSize', 22);
title('\fontsize{22}Log plot of |1+M\fontsize{18}z\fontsize{22}| (DeepRF)');
xticks(-200:100:200); yticks(0.5:0.5:2.0);
